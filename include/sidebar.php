...
<div class="w3-main" style="margin-left:340px;margin-right:40px">
  ...
  <div class="w3-container" style="margin-top:80px" id="showcase">
    ...
    <h1 class="w3-xxxlarge w3-text-red"><b>OMR Evaluator</b></h1>
...
<!-- End page content -->
  ...
  <div id="modal01" class="w3-modal bg-white " style="padding-top:0">
    <span class="w3-button w3-black w3-xxlarge w3-display-topright" onclick="document.getElementById('modal01').style.display='none'">&times;</span>
    <div class="w3-modal-content w3-animate-zoom w3-center w3-transparent w3-padding-64" id="omr_content">
    </div>
  </div>
<!-- End page content -->
</div>